...
public class Seekweb {
	...
	private String id;
	private String otherwebsiteid;
	private String extend_int_two;
	...
	public String getOtherwebsiteid() {
		return otherwebsiteid;
	}


	public void setOtherwebsiteid(String otherwebsiteid) {
		this.otherwebsiteid = otherwebsiteid;
	}


	public String getExtend_int_two() {
		return extend_int_two;
	}


	public void setExtend_int_two(String extend_int_two) {
		this.extend_int_two = extend_int_two;
	}
	...
	public String toString() {
		return "Seekweb [website_name=" + website_name + ", config_name=" + config_name + ", create_date=" + create_date
				+ ", status=" + status + ", sum_value=" + sum_value + ", id=" + id + ", otherwebsiteid="
				+ otherwebsiteid + ", extend_int_two=" + extend_int_two + ", doc_count=" + doc_count + ", url=" + url
