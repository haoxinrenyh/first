...
public class DataMonitorVO {
	...
	private String commentsvolume;
	private String forwardingvolume;
	...
	public void setPraisevolume(String praisevolume) {
		this.praisevolume = praisevolume;
	}
	public String getCommentsvolume() {
		return commentsvolume;
	}
	public void setCommentsvolume(String commentsvolume) {
		this.commentsvolume = commentsvolume;
	}
	public String getForwardingvolume() {
		return forwardingvolume;
	}
	public void setForwardingvolume(String forwardingvolume) {
		this.forwardingvolume = forwardingvolume;
	}
	public String getExtend_string_one() {
		return extend_string_one;
	}
	public void setExtend_string_one(String extend_string_one) {
		this.extend_string_one = extend_string_one;
	}
