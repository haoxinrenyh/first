...
import com.stonedt.spider.expression.interpreter.AstInterpreter;
import com.stonedt.spider.expression.parsing.Ast;
import com.stonedt.spider.expression.parsing.Ast.Node;
import com.stonedt.spider.expression.parsing.Parser;
...
public class ExpressionTemplate {
	...
	public Object render (ExpressionTemplateContext context, Map<String, Object> variables) {
		return AstInterpreter.interpret(this, context,variables);
	}
}
