...
//	private final String es_url = "http://s1.stonedt.com:6303";
	...
	private final String moviebyregion_api = "/movie/moviebyregion";
	private final String movielist_api = "/movie/movielist";
	private final String getmovie_api =  "/movie/getmovie";
	
	/**
	 * 	筛选
	 */
	@RequestMapping(value = "/moviebyregion", method = RequestMethod.POST, produces = "application/json;charset=utf-8")
	@ResponseBody
	public String decorateLevels() {
		String url = es_url + moviebyregion_api;
	 ...
	 * 	列表
	 */
	@RequestMapping(value = "/movielist", method = RequestMethod.POST, produces = "application/json;charset=utf-8")
	@ResponseBody
	public String thesisnlist(String pageNum, String matchingmode, String time, String searchkeyword,
		...
		try {
			response = esArticle(map, movielist_api);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String detail(String article_public_id) {
		String url = es_url + getmovie_api;
