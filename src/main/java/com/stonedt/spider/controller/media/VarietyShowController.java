...
//	private final String es_url = "http://s1.stonedt.com:6303";
	...
	private final String varietyshowbytype_api = "/varietyshow/varietyshowbytype";
	private final String varietyshowlist_api = "/varietyshow/varietyshowlist";
//	private final String getvarietyshow_api =  "/varietyshow/getvarietyshow";
	
	/**
	 * 	筛选
	 */
	@RequestMapping(value = "/varietyshowbytype", method = RequestMethod.POST, produces = "application/json;charset=utf-8")
	@ResponseBody
	public String decorateLevels() {
		String url = es_url + varietyshowbytype_api;
	 ...
	 * 	列表
	 */
	@RequestMapping(value = "/varietyshowlist", method = RequestMethod.POST, produces = "application/json;charset=utf-8")
	@ResponseBody
	public String thesisnlist(String pageNum, String matchingmode, String time, String searchkeyword,
		...
		try {
			response = esArticle(map, varietyshowlist_api);
		} catch (Exception e) {
			e.printStackTrace();
...
//		String url = es_url + getvarietyshow_api;
...
//	}
	...
	@RequestMapping(value = "/variety-show", method = RequestMethod.GET)
	public ModelAndView mainstreamMediaList(ModelAndView mv) {
		mv.addObject("nowArray", DateUtil.getNowDate());
		mv.setViewName("mediaData/variety-show");
		return mv;
	}
	
//	@RequestMapping(value = "/variety-show-detail", method = RequestMethod.GET)
//	public ModelAndView aaa(ModelAndView mv) {
//		mv.setViewName("variety-show-detail");
//		return mv;
//	}
